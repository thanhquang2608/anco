    ...
    $scope.updateHeo = function (ac_pc, isValid) {
        ...
        if ($scope.update) {
            ...
            var param = {
                ...
                ac_sl:   $scope.heo.HEO_ANCO == 0 ? 0 : $scope.heo.HEO_ANCO_SL,
                ac_con:  $scope.heo.HEO_ANCO == 0 ? 0 : $scope.heo.HEO_ANCO_HEO,
                ac_thit: $scope.heo.HEO_ANCO == 0 ? 0 : $scope.heo.HEO_ANCO_THIT,
                ac_nai:  $scope.heo.HEO_ANCO == 0 ? 0 : $scope.heo.HEO_ANCO_NAI,

                cc_kd: $scope.heo.HEO_CONCO,
                cc_mua:  $scope.heo.HEO_CONCO == 0 ? 0 : $scope.heo.HEO_CONCO_MUA_TT,
                cc_sl:   $scope.heo.HEO_CONCO == 0 ? 0 : $scope.heo.HEO_CONCO_SL,
                cc_con:  $scope.heo.HEO_CONCO == 0 ? 0 : $scope.heo.HEO_CONCO_HEO,
                cc_thit: $scope.heo.HEO_CONCO == 0 ? 0 : $scope.heo.HEO_CONCO_THIT,
                cc_nai:  $scope.heo.HEO_CONCO == 0 ? 0 : $scope.heo.HEO_CONCO_NAI,

                cp_kd: $scope.heo.HEO_CP,
                cp_mua:  $scope.heo.HEO_CP == 0 ? 0 : $scope.heo.HEO_CP_MUA_TT,
                cp_sl:   $scope.heo.HEO_CP == 0 ? 0 : $scope.heo.HEO_CP_SL,
                cp_con:  $scope.heo.HEO_CP == 0 ? 0 : $scope.heo.HEO_CP_HEO,
                cp_thit: $scope.heo.HEO_CP == 0 ? 0 : $scope.heo.HEO_CP_THIT,
                cp_nai:  $scope.heo.HEO_CP == 0 ? 0 : $scope.heo.HEO_CP_NAI,

                cg_kd: $scope.heo.HEO_CG,
                cg_mua:  $scope.heo.HEO_CG == 0 ? 0 : $scope.heo.HEO_CG_MUA_TT,
                cg_sl:   $scope.heo.HEO_CG == 0 ? 0 : $scope.heo.HEO_CG_SL,
                cg_con:  $scope.heo.HEO_CG == 0 ? 0 : $scope.heo.HEO_CG_HEO,
                cg_thit: $scope.heo.HEO_CG == 0 ? 0 : $scope.heo.HEO_CG_THIT,
                cg_nai:  $scope.heo.HEO_CG == 0 ? 0 : $scope.heo.HEO_CG_NAI,

                gf_kd: $scope.heo.HEO_GF,
                gf_mua:  $scope.heo.HEO_GF == 0 ? 0 : $scope.heo.HEO_GF_MUA_TT,
                gf_sl:   $scope.heo.HEO_GF == 0 ? 0 : $scope.heo.HEO_GF_SL,
                gf_con:  $scope.heo.HEO_GF == 0 ? 0 : $scope.heo.HEO_GF_HEO,
                gf_thit: $scope.heo.HEO_GF == 0 ? 0 : $scope.heo.HEO_GF_THIT,
                gf_nai:  $scope.heo.HEO_GF == 0 ? 0 : $scope.heo.HEO_GF_NAI,

                o_kd: $scope.heo.HEO_ANOTHER,
                o_mua:  $scope.heo.HEO_ANOTHER == 0 ? 0 : $scope.heo.HEO_ANOTHER_MUA_TT,
                o_sl:   $scope.heo.HEO_ANOTHER == 0 ? 0 : $scope.heo.HEO_ANOTHER_SL,
                o_con:  $scope.heo.HEO_ANOTHER == 0 ? 0 : $scope.heo.HEO_ANOTHER_HEO,
                o_thit: $scope.heo.HEO_ANOTHER == 0 ? 0 : $scope.heo.HEO_ANOTHER_THIT,
                o_nai:  $scope.heo.HEO_ANOTHER == 0 ? 0 : $scope.heo.HEO_ANOTHER_NAI
            }
            if (Dealers.survey().HEO_ID != null) {
